...
interface ServiceItemProps {
  ...
  description: string;
  items: string[];
  imageSrc: string; // Changed from imagePlaceholder to imageSrc
  imageAlt: string; // Added alt text prop
  imagePosition?: 'left' | 'right'; // Optional prop for alternating image position
}

const ServiceItem: React.FC<ServiceItemProps> = ({ title, description, items, imageSrc, imageAlt, imagePosition = 'left' }) => (
  <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
    {/* Image - Now uses Image component */}
  ...
  const services: ServiceItemProps[] = [
    {
      ...
      imageSrc: "/cozinhas/cozinhas-15.jpg", // Example image
    ...
    },
    {
      ...
      imageSrc: "/dormitorios/dormitorios-12.jpg", // Example image
      imageAlt: "Dormitório planejado D&A Móveis",
      imagePosition: 'right' // Alternate position
    },
    {
      ...
      imageSrc: "/salas/salas-30.jpg", // Example image
    ...
    },
    {
      ...
      imageSrc: "/escritorios/escritorios-02.jpg", // Example image
    ...
    },
    {
      ...
      imageSrc: "/banheiros/banheiros-05.jpg", // Example image
    ...
    },
    {
      ...
      imageSrc: "/area_lazer/area-lazer-01.jpg", // Example image
    ...
    },
     {
      ...
      imageSrc: "/corporativo/corporativo-25.jpg", // Example image
